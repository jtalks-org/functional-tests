 ...
 * @autor masyan
 */
public class JC114ImpossibleToSendPrivateMessageToYourselfFromProfile {
	...
	@Test
	public void impossibleToSendPrivateMessageToYourselfFromProfileTest() {
		CollectionHelp.getFirstWebElementFromCollection(postPage.getAuthorsOfPostsList()).click();

		assertionNotExistBySelector(driver, profilePage.newPrivateMessageButtonSel);
	}
}
