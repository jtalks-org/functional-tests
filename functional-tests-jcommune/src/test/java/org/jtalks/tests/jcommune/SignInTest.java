...
public class SignInTest {
    ...
    public void signInWithoutActivationRegistration_ShouldFailLogin() throws Exception {
        User user = Users.signUp();
        Users.signIn(user);
    }

    @Test
    public void usernameAndPasswordCorrect_ShouldLogin() throws Exception {
        User user = Users.signUp();
        Users.activate(user);
        Users.logout();
        Users.signIn(user);
    ...
    public void usernameEmpty_ShouldFailLogin() throws Exception {
    ...
    @Test(expectedExceptions = ValidationException.class,
            expectedExceptionsMessageRegExp = SignInPage.LOGIN_ERROR)
    public void usernameNotExist_ShouldFailLogin() throws Exception {
        User user = Users.signUp();
        Users.activate(user);
        Users.logout();
    ...
    @Test(expectedExceptions = ValidationException.class,
            expectedExceptionsMessageRegExp = SignInPage.LOGIN_ERROR)
    public void passwordIncorrect_ShouldFailLogIn() throws Exception {
        User user = Users.signUp();
        Users.activate(user);
        Users.logout();
    ...
    @Test(expectedExceptions = ValidationException.class,
            expectedExceptionsMessageRegExp = SignInPage.LOGIN_ERROR)
    public void usernameAndPasswordNotExist_ShouldFailLogin() throws Exception {
    ...
    @Test
    public void usernameIsCaseInsensitive_ShouldLogin() throws Exception {
        User user = Users.signUp();
        Users.activate(user);
        Users.logout();
    ...
    @Test(expectedExceptions = ValidationException.class,
            expectedExceptionsMessageRegExp = SignInPage.LOGIN_ERROR)
    public void passwordIsCaseInsensitive_ShouldFailLogin() throws Exception {
        User user = Users.signUp();
        Users.activate(user);
        Users.logout();
    ...
    @Test
    public void usernameContainsSlash_ShouldLogin() throws Exception {
