...
public class BbCodeTest {
    ...
    public Object[][] bbCodesWithMessage_thatShouldPass() {
        ...
        return new String[][]{
                ...
                {"[b]" + randomAlphanumeric(20000) + "[/b]", "BB code [b] validation failed! " + maxBoundaryMessage},
                ...
                {"[i]" + randomAlphanumeric(20000) + "[/i]", "BB code [i] validation failed! " + maxBoundaryMessage},
                ...
                {"[s]" + randomAlphanumeric(20000) + "[/s]", "BB code [s] validation failed! " + maxBoundaryMessage},
                ...
                {"[u]" + randomAlphanumeric(20000) + "[/u]", "BB code [u] validation failed! " + maxBoundaryMessage},
                ...
                {"[highlight]" + randomAlphanumeric(20000) + "[/highlight]", "BB code [highlight] validation failed! " + maxBoundaryMessage},
                ...
                {"[left]" + randomAlphanumeric(20000) + "[/left]", "BB code [left] validation failed! " + maxBoundaryMessage},
                ...
                {"[center]" + randomAlphanumeric(20000) + "[/center]", "BB code [center] validation failed! " + maxBoundaryMessage},
                ...
                {"[right]" + randomAlphanumeric(20000) + "[/right]", "BB code [right] validation failed! " + maxBoundaryMessage},
                ...
                {"[list][*]" + randomAlphanumeric(20000) + "[/list]", "BB code [list] validation failed! " + maxBoundaryMessage},
                ...
                {"[color=000099]" + randomAlphanumeric(20000) + "[/color]", "BB code [color] validation failed! " + maxBoundaryMessage},
                ...
                {"[size=7]" + randomAlphanumeric(20000) + "[/size]", "BB code [size] validation failed! " + maxBoundaryMessage},
                ...
                {"[size=9]" + randomAlphanumeric(20000) + "[/size]", "BB code [size] validation failed! " + maxBoundaryMessage},
                ...
                {"[size=12]" + randomAlphanumeric(20000) + "[/size]", "BB code [size] validation failed! " + maxBoundaryMessage},
                ...
                {"[size=18]" + randomAlphanumeric(20000) + "[/size]", "BB code [size] validation failed! " + maxBoundaryMessage},
                ...
                {"[size=24]" + randomAlphanumeric(20000) + "[/size]", "BB code [size] validation failed! " + maxBoundaryMessage},
                ...
                {"[img]" + randomAlphanumeric(20000) + "[/img]", "BB code [img] validation failed! " + wrongLinkInsideBbCodesTagsMessage},
                ...
                {"[url=new link]" + randomAlphanumeric(20000) + "[/url]", "BB code [url] validation failed! " + wrongLinkInsideBbCodesTagsMessage},
                ...
                {"[code=cpp]" + randomAlphanumeric(20000) + "[/code]", "BB code [code] validation failed! " + maxBoundaryMessage},
                ...
                {"[quote]" + randomAlphanumeric(20000) + "[/quote]", "BB code [quote] validation failed! " + maxBoundaryMessage},
                ...
                {"[indent=15]" + randomAlphanumeric(20000) + "[/indent]", "BB code [indent] validation failed! " + maxBoundaryMessage},
