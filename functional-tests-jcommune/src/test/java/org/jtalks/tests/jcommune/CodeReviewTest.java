...
public class CodeReviewTest {
    ...
    @Test
    public void signUpAndCreateCodeReview_ShouldPass() throws Exception {
        CodeReview codeReview = new CodeReview().setBranch("Acids and Bases");
    ...
    public void createCodeReviewWithEmptyTitle_ShouldFail() throws Exception {
        CodeReview codeReview = new CodeReview().setTitle("");
        Users.signUpAndSignIn();
        Topics.createCodeReview(codeReview);
    }
    ...
    public void createCodeReviewWithMinTitle_ShouldPass() throws Exception {
        CodeReview codeReview = new CodeReview().setTitle(randomAlphanumeric(1));
        Users.signUpAndSignIn();
        Topics.createCodeReview(codeReview);
    }
    ...
    @Test
     public void createCodeReviewWithMaxTitle_ShouldPass() throws Exception {
        CodeReview codeReview = new CodeReview().setTitle(randomAlphanumeric(120));
        Users.signUpAndSignIn();
        Topics.createCodeReview(codeReview);
    }
    ...
    public void createCodeReviewExceedingMaxTitle_ShouldFail() throws Exception {
        CodeReview codeReview = new CodeReview().setTitle(randomAlphanumeric(121));
        Users.signUpAndSignIn();
        Topics.createCodeReview(codeReview);
    }
    ...
    public void createCodeReviewWithMultipleLines_ShouldPass() throws Exception {
        CodeReview codeReview = new CodeReview().withContent(randomAlphanumeric(400));
        Users.signUpAndSignIn();
        Topics.createCodeReview(codeReview);
    }
