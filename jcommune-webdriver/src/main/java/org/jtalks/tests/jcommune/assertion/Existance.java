...
public class Existance {
    ...
    public static void assertionNotExistBySelector(WebDriver driver, String selector) {
        try {
            ...
            //if exist then fail
            Assert.fail("The element with selector=\"" + selector + "\" should not exist");
     ...
     * @param selector Selector to find element
     */
    public static void assertElementExistsByCssSelector(WebDriver driver, String selector) {
        try {
            WebElement f = driver.findElement(By.cssSelector(selector));
        } catch (NoSuchElementException e) {
            //if not exist then fail
            Assert.fail("The element with selector=\"" + selector + "\" should exist");
        }
    ...
    public static void assertionNotExistById(WebDriver driver, String id) {
        try {
            ...
            //if exist then fail
            Assert.fail("The element with id=\"" + id + "\" should not exist");
        } catch (NoSuchElementException e) {
        }
    }
    ...
    public static void assertionExistById(WebDriver driver, String id) {
        try {
            ...
            //if exist then fail
            Assert.fail("The element with id=\"" + id + "\" should exist");
        }
    }
    ...
    public static void assertionNotEmptyCollection(List<WebElement> webElementsList) {
        if (webElementsList.size() == 0) {
            Assert.fail("Elements collection is empty");
        }
    }
    ...
    public static void assertionContainsInString(String str, String find) {
        if (!str.contains(find)) {
            Assert.fail("String does not contain the search pattern");
        }
    }
    ...
    public static void assertionNotContainsInString(String str, String find) {
        if (str.contains(find)) {
            Assert.fail("String contains the search pattern");
        }
    }
    ...
    public static void assertionNotExistElementOnViewPresent(List<WebElement> list, String text) {
        for (WebElement webElement : list) {
            ...
            if (t.equals(text)) {
                Assert.fail("WebElement with text '" + text + "' exist on view");
            }
        }
    }
    ...
    public static void assertionExistElementOnViewPresent(List<WebElement> list, String text) {
        ...
        if (!exist) {
            Assert.fail("WebElement with text '" + text + "' not exist on view");
        }
    }
    ...
    public static void assertionContainsStringInList(List<String> list, String text) {
        if (!list.contains(text)) {
            Assert.fail("Element with text '" + text + "' not contained in list");
        }
    }
