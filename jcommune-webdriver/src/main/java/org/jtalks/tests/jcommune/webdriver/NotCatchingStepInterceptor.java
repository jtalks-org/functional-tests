...
public class NotCatchingStepInterceptor extends StepInterceptor{
    ...
    public NotCatchingStepInterceptor(final Class<?> testStepClass) {
        super(testStepClass);
    ...
    private Object invokeMethodAndNotifyFailures(Object obj, Method method, Object[] args, MethodProxy proxy, Object result) throws Throwable {
        try {
            ...
            notifyStepStarted(method, args);
//            notifyStepPending("Error happened on this step which might be expected: " + error.getMessage());
